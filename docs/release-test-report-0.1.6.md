...
- Debug 构建：0 警告、0 错误。
- 核心单元测试：84/84 通过；安装器测试：19/19 通过。
...
- C 盘只读审计：以 E 盘 `TEMP` 和 bundle 提取目录运行，监控项 182 → 182、物理变化 0；便携版、安装版和 Runtime Bootstrapper 均完成实际隐藏启动。原始结果：`.tmp/c-drive-release-audit-20260804-103203/result.json`；稳定摘要：`docs/acceptance/c-drive-release-audit-0.1.6.json`。

## 发布文件

| 文件 | 大小 | SHA-256 |
|---|---:|---|
| `CodexAgentSwitch-win10-x64.zip` | 94,334,760 | `9d73f8afe1fa36e14c1481502e59ffdd2e147de9092650abe848d785392d5590` |
| `CodexAgentSwitch-compact-runtime-win10-x64.zip` | 237,664,434 | `2fbfd4f305668fa22cbbfa33e5f461b31e8c94a9c9648d865240f6e846f78aa5` |
| `CodexAgentSwitch-Setup-Bundle-win10-x64.zip` | 413,292,333 | `1331478981e4fb42009679e0c268ee308a8d1e8e0bf2f4d118b52e83be092d54` |

当前 `release-manifest.json` 已逐项验证大小与 SHA-256；便携 App、Setup 和 Runtime Bootstrapper 的文件版本为 `0.1.6.0`，Runtime 安装器 Authenticode 签名为 Microsoft 有效签名。最终提交后会重新生成发布包，使产品版本关联最终提交。
