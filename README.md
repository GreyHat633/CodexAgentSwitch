...
Codex Agent Switch（CAS）的目的在于让 **Sol 主代理负责分析、策划、拆分和验收**，把边界清晰的实施工作交给成本更低的工作代理，从而减少高成本主模型的额度消耗。

CAS 不替代 Codex，也不靠降低任务质量来省额度，而是通过明确主代理与工作代理的职责，让昂贵的 Sol 只处理真正需要全局判断的部分。
