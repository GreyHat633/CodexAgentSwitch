...
pwsh -File .\scripts\package.ps1 -Version 0.1.3 -IncludeRuntimeInstaller
```

所有 .NET、NuGet、临时和发布状态均重定向到仓库所在 E 盘目录。交付文档见 [ARCHITECTURE.md](ARCHITECTURE.md)、[SECURITY.md](SECURITY.md)、[PRIVACY.md](PRIVACY.md) 与 `docs/`；0.1.3 的 C 盘事故复核、修复和 Win10 验收记录在 `docs/release-test-report-0.1.3.md`。
